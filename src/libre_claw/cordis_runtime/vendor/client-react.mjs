// React 18.3.1 and react-reconciler 0.29.2. See THIRD_PARTY_NOTICES.md.
...
// client-react-entry.mjs
var import_react = __toESM(require_react(), 1);
var jsxRuntime = __toESM(require_jsx_runtime(), 1);
var import_react_reconciler = __toESM(require_react_reconciler(), 1);
var ReconcilerConstants = __toESM(require_constants(), 1);
var export_React = import_react.default;
var export_Reconciler = import_react_reconciler.default;
export {
  export_React as React,
  export_Reconciler as Reconciler,
  ReconcilerConstants,
  jsxRuntime
};
